...
def embedresult(response:json):
    ...
    embedresult.set_footer(text="Made By LOSTANA#8282", icon_url="https://cdn.discordapp.com/attachments/673144200669167651/948558799084597248/1642407548942-10.png")
...
def embedresult_lister(response:json):
    ...
    for listers in response["CharacterList"]:
        if int(listers["Level"][listers["Level"].find('Lv.')+3:listers["Level"].rfind('.')].replace(',','')) >= 1340:
            lisrrr = lisrrr + "[`" + listers["Server"] + "`] [`" + listers["Level"] + "`] [`" + listers["Class"] + "`] [`" + listers["Name"] + "`]\n"

    if lisrrr == "":
        lisrrr = "1,340레벨 이상 캐릭터 없음"

    embedresult_lister = discord.Embed(title="캐릭터 목록", color=discord.Color.green())

    embedresult_lister.add_field(
        name="▫️ 1,340레벨 이상 캐릭터만 표기됩니다.",
        value=(lisrrr)
    )

    embedresult_lister.set_footer(text="Made By LOSTANA#8282", icon_url="https://cdn.discordapp.com/attachments/673144200669167651/948558799084597248/1642407548942-10.png")
...
def embedskill(response:json):
    ...
    embedskill.set_footer(text="Made By LOSTANA#8282", icon_url="https://cdn.discordapp.com/attachments/673144200669167651/948558799084597248/1642407548942-10.png")
...
def embedresult_jewlist(response:json):
    ...
    embedresult_jewlist.set_footer(text="Made By LOSTANA#8282", icon_url="https://cdn.discordapp.com/attachments/673144200669167651/948558799084597248/1642407548942-10.png")
...
def embedresult_goldget(response:json):
    ...
    embedresult_goldget.set_footer(text="Made By LOSTANA#8282", icon_url="https://cdn.discordapp.com/attachments/673144200669167651/948558799084597248/1642407548942-10.png")
...
def embedresult_sasalist(response:json, 닉네임:str):
    ...
    embedresult_sasalist.set_footer(text="Made By LOSTANA#8282", icon_url="https://cdn.discordapp.com/attachments/673144200669167651/948558799084597248/1642407548942-10.png")
...
def embedresult_auction(가격:int):
    ...
    embedresult_auction.set_footer(text="Made By LOSTANA#8282", icon_url="https://cdn.discordapp.com/attachments/673144200669167651/948558799084597248/1642407548942-10.png")
...
def embedresult_crystal(response:json):
    ...
    embedresult_crystal.set_footer(text="Made By LOSTANA#8282", icon_url="https://cdn.discordapp.com/attachments/673144200669167651/948558799084597248/1642407548942-10.png")
...
def embedresult_island(response:json):
    ...
    embedresult_island.set_footer(text="Made By LOSTANA#8282", icon_url="https://cdn.discordapp.com/attachments/673144200669167651/948558799084597248/1642407548942-10.png")
...
def embedresult_gearlist(response:json):
    ...
    embedresult_gearlist.set_footer(text="Made By LOSTANA#8282", icon_url="https://cdn.discordapp.com/attachments/673144200669167651/948558799084597248/1642407548942-10.png")
...
def embedresult_gear2list(response:json):
    ...
    embedresult_gear2list.set_footer(text="Made By LOSTANA#8282", icon_url="https://cdn.discordapp.com/attachments/673144200669167651/948558799084597248/1642407548942-10.png")
